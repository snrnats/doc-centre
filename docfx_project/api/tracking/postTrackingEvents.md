...
Post tracking events for a consignment

`POST https://api.electioapp.com/tracking/carrierevents`

> <span class="note-header">Note:</span>
>
> This endpoint is designed for us by carriers in order to provide tracking details to Sorted.
