...
> [!NOTE]
> For full reference information on the **Allocate Shipment with Service Group** endpoint, see the [Shipments data contract](/pro/api/reference/shipments-api-ref.html#tag/Allocation/paths/~1shipments~1{shipmentReference}~1allocate~1service_group~1{groupReference}/put). 
...
> [!NOTE]
> For information on available service capabilities and values, see the [Shipments data contract](/pro/api/reference/shipments-api-ref.html#tag/Allocation/paths/~1shipments~1allocate~1service_group/put).
...
> [!NOTE]
> For full reference information on the **Allocate with Service Group** endpoint, see the [Shipments data contract](/pro/api/reference/shipments-api-ref.html#tag/Allocation/paths/~1shipments~1allocate~1service_group/put). 
