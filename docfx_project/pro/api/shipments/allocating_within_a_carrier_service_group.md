...
> [!NOTE]
> For full reference information on the **Allocate Shipment with Service Group** endpoint, see LINK HERE. 
...
> [!NOTE]
> For full reference information on the **Allocate with Service Group** endpoint, see LINK HERE. 
