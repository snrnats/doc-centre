...
> [!NOTE]
> * For reference information on **Allocate With Quote**, see the [Shipments API reference](/pro/api/reference/shipments-api-ref.html#tag/Allocation/paths/~1shipments~1{shipmentReference}~1allocate/put).
