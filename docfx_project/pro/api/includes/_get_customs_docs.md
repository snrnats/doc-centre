...
You will need to decode the Files' Base64 data in order to view or print the documents. If you are unsure how to do this, see the **[MDN docs](https://developer.mozilla.org/en-US/docs/Web/API/WindowBase64/Base64_encoding_and_decoding)** for more information.
