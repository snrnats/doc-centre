...
To allocate one or more consignments based on your organisation's custom allocation rules, use the **[Allocate Using Default Rules](https://docs.electioapp.com/#/api/AllocateUsingDefaultRules)** endpoint. PRO allows for the configuration of custom allocations rules - such as allowed package dimensions, maximum consignment value, and geographical restrictions - against individual carrier services. You can configure them via the <strong>Manage Carrier Service Rules</strong></a> page of the PRO UI. 
