...
* **PARCELFORCE INTL** - Customs document required. Affects GB to all non-GB destinations
    > [!NOTE]
    > Parcelforce's **Euro Priority Business** and **Euro Priority Home** services have been renamed to **Euro Priority** and **Euro Economy Home** respectively. This name change do not affect the services in any way.
